...
bucket = s3.create_bucket(Bucket='kongvideolyzervideos')
bucket = s3.create_bucket(Bucket='kongvideolyzervideos', LocationConstraint=session.region_name)
bucket = s3.create_bucket(Bucket='kongvideolyzervideos')
...
pathname = '~\Downloads\Pexel Videos 2364297.mp4'
